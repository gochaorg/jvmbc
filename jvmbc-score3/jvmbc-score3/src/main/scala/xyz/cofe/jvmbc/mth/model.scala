 ...
 */
case class MMaxs(maxStack:Int,maxLocal:Int) 
  extends MethCode
 ...
 * @param iface
 */
enum MInvoke extends MethCode:
  case Virtual( owner:JavaName, name:String, desc:MDesc, iface:Boolean )
  case Static( owner:JavaName, name:String, desc:MDesc, iface:Boolean )
  case Special( owner:JavaName, name:String, desc:MDesc, iface:Boolean )
  case Iterface( owner:JavaName, name:String, desc:MDesc, iface:Boolean )
  /**
  ...
  */
  ...
  ) extends MInvoke with MethCode with NestedAll
 ...
 * @param numDimensions
 */
case class MMultiANewArrayInsn(desc:TDesc,numDimensions:Int) 
  extends MethCode
